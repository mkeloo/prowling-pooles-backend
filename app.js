...
const playerStatisticsRouter = require('./src/api/player_statistics');
const notesRouter = require('./src/api/notes');
...
app.use('/api/player_statistics', playerStatisticsRouter);
